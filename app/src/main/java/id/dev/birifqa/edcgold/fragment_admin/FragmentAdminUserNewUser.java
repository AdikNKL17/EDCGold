...
public class FragmentAdminUserNewUser extends Fragment {
    ...
    private void onAction(){
        Api.adminUserNewUserModels = new ArrayList<>();
        userAdapter = new AdminUserAdapter(getActivity(), Api.adminUserNewUserModels);
    ...
    private void getData(){
        Api.adminUserNewUserModels.clear();

        dialog.show();
        Call<ResponseBody> call = ParamReq.requestUserList(Session.get("token"), "1", "0", "", getActivity());
