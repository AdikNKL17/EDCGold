...
public class UserAktifitasAdapter extends RecyclerView.Adapter<UserAktifitasAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.tvNominal.setText(aktifitas.getNominal());
        holder.tvTitle.setText(aktifitas.getTitle());
        holder.tvStatus.setText(aktifitas.getStatus());
        holder.tvDate.setText(aktifitas.getDate());

        if (aktifitas.getTipe().equals("1")){
