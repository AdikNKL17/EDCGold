...
public class UserReceiveModel {
    ...
    public UserReceiveModel() {
    }

    public UserReceiveModel(String id, String buyer_id, String seller_id, String transaction_code, String method, String nominal, String balance_point, String balance_coin, String amount_point, String amount_coin, String status, String description, String created_at, String updated_at, String type_transfer) {
        this.id = id;
