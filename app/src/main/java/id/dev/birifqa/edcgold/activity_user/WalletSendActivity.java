            ...
            public void onClick(View v) {
                if (pagerPosition == 0){
                    if (!Session.get("topup_nominal").equals("")){
                        ...
                        Toast.makeText(WalletSendActivity.this, "Harap pilih nominal topup", Toast.LENGTH_SHORT).show();
                    }
                }else if (pagerPosition == 1){
                    if (!Session.get("topup_bank_name").equals("")){
                        pager.setCurrentItem(pagerPosition+1, true);
                    }else {
                        Toast.makeText(WalletSendActivity.this, "Harap pilih bank", Toast.LENGTH_SHORT).show();
                    }
                }
