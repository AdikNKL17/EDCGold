...
public class AdminUserMiningHistoryModel {
    ...
    public AdminUserMiningHistoryModel(String id, String user_id, String sewa_mining_id, String coin_balance, String aging_result, String days_to, String created_at, String updated_at) {
        this.id = id;
