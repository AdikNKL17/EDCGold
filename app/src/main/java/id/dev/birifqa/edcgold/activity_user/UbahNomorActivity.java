...
public class UbahNomorActivity extends AppCompatActivity {
    ...
    TextInputEditText etPhoneLama, etPhoneBaru, etKonfirmasi;
    ...
    private void changePhone(){
        if (!etPhoneLama.getText().toString().isEmpty() && !etPhoneBaru.getText().toString().isEmpty() && !etKonfirmasi.getText().toString().isEmpty()){
            Call<ResponseBody> call = ParamReq.changePhone(etPhoneLama.getText().toString(), etPhoneBaru.getText().toString(), etKonfirmasi.getText().toString(), UbahNomorActivity.this);
            Callback<ResponseBody> cBack = new Callback<ResponseBody>() {
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    try {
                        ...
                        if (handle) {
                            onBackPressed();
                            Toast.makeText(UbahNomorActivity.this, "Ubah Email Berhasil!!!", Toast.LENGTH_SHORT).show();
                        } else {
