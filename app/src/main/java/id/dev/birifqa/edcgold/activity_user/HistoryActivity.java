...
import id.dev.birifqa.edcgold.fragment_user.HistoryProsesFragment;
import id.dev.birifqa.edcgold.fragment_user.HistorySelesaiFragment;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    public class PagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return new HistoryProsesFragment();
                case 1:
                    return new HistorySelesaiFragment();
